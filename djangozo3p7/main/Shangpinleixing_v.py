...
def shangpinleixing_alipay(request):
    if request.method in ["POST", "GET"]:
        ...
        order_string = alipay.api_alipay_trade_page_pay(
            ...
            return_url='http://localhost:8080/djangozo3p7/shangpinleixing/notify',
            #notify_url=''
        )
...
def shangpinleixing_notify(request):
    if request.method in ["POST", "GET"]:
        ...
        return redirect('http://localhost:8080/djangozo3p7/admin/dist/index.html#/shangpinleixing')
