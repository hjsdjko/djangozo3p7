...
def orders_alipay(request):
    if request.method in ["POST", "GET"]:
        ...
        order_string = alipay.api_alipay_trade_page_pay(
            ...
            return_url='http://localhost:8080/djangozo3p7/orders/notify',
            #notify_url=''
        )
...
def orders_notify(request):
    if request.method in ["POST", "GET"]:
        ...
        cursor = connection.cursor()
        cursor.execute("update orders set status='已支付' where orderid = '{0}'".format(out_trade_no))
        
        return redirect('http://localhost:8080/djangozo3p7/admin/dist/index.html#/orders')
