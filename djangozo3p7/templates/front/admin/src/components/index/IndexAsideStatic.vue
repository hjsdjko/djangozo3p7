...
<style lang="scss" scoped>
  ...
  .index-aside {
	...
	.menulist-item {
		...
		background: #fff url("http://codegen.caihongy.cn/20211124/f19da34bf1474426a7e28006977e79e7.png") repeat top !important;
		...
		& /deep/ .el-menu.el-menu--inline {
			...
			.el-menu-item {
				...
				padding: 0 !important;
				margin: 0;
				color: rgba(12, 107, 92, 1) !important;
				font-size: 14px;
				border-radius: 0;
                ...
                &.is-active {
                    ...
                    background-color: rgba(12, 107, 92, 0.74) !important;
                    box-shadow: 0 0 6px rgba(30, 144, 255, 0);
                    text-align: center;
                }
				...
				&:hover {
					...
					border-style: solid;
					border-color: rgba(0, 0, 0, 0);
					background-color: rgba(12, 107, 92, 1) !important;
					box-shadow: 0 0 6px rgba(30, 144, 255, 0);
					text-align: center;
				}
			}
