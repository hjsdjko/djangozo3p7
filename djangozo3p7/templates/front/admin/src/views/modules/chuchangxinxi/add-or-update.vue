<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车位类型" prop="cheweileixing">
          <el-input v-model="ruleForm.cheweileixing" 
              placeholder="车位类型" clearable  :readonly="ro.cheweileixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="车位类型" prop="cheweileixing">
              <el-input v-model="ruleForm.cheweileixing" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="停车价格" prop="tingchejiage">
          <el-input v-model="ruleForm.tingchejiage" 
              placeholder="停车价格" clearable  :readonly="ro.tingchejiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="停车价格" prop="tingchejiage">
              <el-input v-model="ruleForm.tingchejiage" 
                placeholder="停车价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="入场时间" prop="ruchangshijian">
          <el-input v-model="ruleForm.ruchangshijian" 
              placeholder="入场时间" clearable  :readonly="ro.ruchangshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="入场时间" prop="ruchangshijian">
              <el-input v-model="ruleForm.ruchangshijian" 
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="出场时间" prop="chuchangshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chuchangshijian" label="出场时间" prop="chuchangshijian">
              <el-input v-model="ruleForm.chuchangshijian" 
                placeholder="出场时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `chuchangxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.chuchangxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
