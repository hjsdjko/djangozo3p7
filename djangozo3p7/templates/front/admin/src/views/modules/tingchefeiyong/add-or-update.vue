<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出场时间" prop="chuchangshijian">
          <el-input v-model="ruleForm.chuchangshijian" 
              placeholder="出场时间" clearable  :readonly="ro.chuchangshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出场时间" prop="chuchangshijian">
              <el-input v-model="ruleForm.chuchangshijian" 
