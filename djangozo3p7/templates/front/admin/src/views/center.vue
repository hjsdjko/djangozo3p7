  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yezhu'"  label="年龄" prop="nianling">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yezhu'"  label="门牌号" prop="menpaihao">
          <el-input v-model="ruleForm.menpaihao"               placeholder="门牌号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='yezhu'"  label="地址" prop="dizhi">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'yezhu' ==this.flag && this.ruleForm.money&&(!isNumber(this.ruleForm.money))){
