<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">基于微信平台小区服务系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			<!-- <div v-if="tableName=='yezhu'" class="input-group">
			   <div class="label">业主号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.yezhuhao" class="input" type="text" placeholder="业主号">
			   </div>
			 </div> -->
			<el-form-item label="业主号" class="input" v-if="tableName=='yezhu'">
			  <el-input v-model="ruleForm.yezhuhao" autocomplete="off" placeholder="业主号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yezhu'" class="input-group">
			...
			<el-form-item label="门牌号" class="input" v-if="tableName=='yezhu'">
			...
			<el-form-item label="地址" class="input" v-if="tableName=='yezhu'">
